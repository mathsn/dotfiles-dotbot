...
__conda_setup="$('/Users/Ning/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
export PATH=$PATH:/opt/local/bin:/opt/local/sbin/:.:/usr/texbin/:/Users/Ning/bin/
